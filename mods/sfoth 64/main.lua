-- name: SFotH IV
-- description: A recreation of the classic Roblox map inside of SM64EX-COOP's Arena Gamemode!
...
gGameLevels = {
    { level = LEVEL_CASTLE_GROUNDS, name = 'SFOTH'    }, --BOB
}
...
function level_check()
    ...
    if np.currLevelNum ~= gGlobalSyncTable.currentLevel then
